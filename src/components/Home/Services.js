...
import { ArrowUpRight, Monitor, Megaphone, Code,BadgeCheck } from 'lucide-react';
...
const ServicesOverview = () => {
  ...
  return (
    <div 
          className="min-h-screen p-4 sm:p-8 w-full relative" 
          style={{ 
...
>
      <div className="max-w-7xl mx-auto">
        ...
        <button 
            className="relative px-2 py-2 text-white text-sm font-medium rounded-md transition-all duration-200 hover:scale-105 active:scale-95 mb-8 flex items-center gap-3"
            style={{
          ...
          >
          <div style={{ backgroundColor: '#B11E9B', borderRadius: '4px', padding: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
