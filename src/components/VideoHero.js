  ...
  const VideoSection = () => {
    ...
    const translateY = Math.min(scrollY * 0.5, 100); // Faster motion
    
    return (
      <div
        className="relative w-full h-screen overflow-hidden bg-black z-40 transition-all duration-300 ease-out"
        style={{
