...
const PioneeringExcellenceSection = () => {
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-black to-purple-900/10"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <h1 className="text-3xl lg:text-4xl xl:text-4xl font-bold text-white leading-tight ">
            ...
            <div className="space-y-8">
              <p className="text-gray-400 text-lg leading-relaxed">
                At Skyline Sprint, we believe in the transformative power of technology 
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-500 text-sm">200+ Agencies Rated</span>
                </div>
              </div>
            </div>
          </div>
